...
At this time, `Window Spy for AHK v2` and the `Ahk2Exe Compiler` are not being released with AutoHotkey v2.0-beta releases.

If you need a copy of `Window Spy for AHK v2` go to [this thread](https://www.autohotkey.com/boards/viewtopic.php?f=83&t=72333) on AHK forums.  You will need to place this in your v2 folders manually until the official release of AHK v2.

If you want the latest version of the `Ahk2Exe Compiler`, you can get it from the latest official AHK v1 zip, or from [here](https://github.com/AutoHotkey/Ahk2Exe).  As of this README update, the link on GitHub is the most up-to-date.

** The latest Ahk2Exe now supports compiling with AutoHotkey v2.0-beta+ releases.**
