...
Separate name and version with a space.  There should be NO spaces in the NAME or VERSION.  Note that all VERSION info comes from folder name.  The type (ANSI / UNICODE) comes from the exe file.
```
